  ...
  def render(%{live_action: :global_search} = assigns) do
    ...
    <div>
      <button
        ...
        class="text-sm font-medium text-gray-900 rounded-lg px-4 lg:px-5 py-2 lg:py-2.5 ring-1 ring-gray-200 hover:bg-gray-50
         focus:outline-none focus:ring-4 focus:ring-gray-100 bg-white gap-2"
      >
