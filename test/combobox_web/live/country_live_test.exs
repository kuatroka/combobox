defmodule ComboboxWeb.CountryLiveTest do
  use ComboboxWeb.ConnCase

  import Phoenix.LiveViewTest
  import Combobox.TerritoryFixtures

  @create_attrs %{country_id: 42, country_code: "some country_code", country_name: "some country_name", iso3: "some iso3"}
  ...
  describe "Index" do
    ...
    test "lists all countries", %{conn: conn, country: country} do
      ...
      assert html =~ country.country_code
    end
    ...
    test "updates country in listing", %{conn: conn, country: country} do
      ...
      assert html =~ "some updated country_code"
    end
